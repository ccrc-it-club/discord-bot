...
module.exports = {
  data: new SlashCommandBuilder()
    .setName("about")
    .setDescription("Shows information about the Club"),
  async execute(interaction, client) {
    const javascriptImage =
      "https://media.discordapp.net/attachments/1029340978823299103/1030798518002126919/Untitled_design.png";
    ...
    const aboutEmbed = new EmbedBuilder()
      ...
      .setDescription(
        "CCRC IT Club is CCRC students' union since 2068 BS contributing" +
